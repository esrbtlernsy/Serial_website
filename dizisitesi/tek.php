...
if(isset($_POST['yorum_gonder'])){
    ...
    $kayit_sorgu = "INSERT INTO `yorumlar`(`uyeID`, `diziID`, `yorum`, `tarih`) VALUES ('".$_SESSION['id']."','".$_GET['id']."','$yorum','".date("Y-m-d H:i:s")."')";
...
<div class="diziler">
    ...
    <div clas="yorumlar" style="padding:10px;" >
        ...
        ?>
        <form action="tek.php?id=<?php echo $_GET['id'];?>" method="POST">
            <textarea name="yorum" style="width:100%;"></textarea>
